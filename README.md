...
[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-2e0aaae1b6195c2367325f4f02e2d04e9abb55f0b24a779b69b11b9e10269abc.svg)](https://classroom.github.com/online_ide?assignment_repo_id=16155735&assignment_repo_type=AssignmentRepo)
# Env_Set
...
3. What is the next step after downloading and extracting the Flutter SDK on Linux? C) Run Flutter Doctor
...
Which option should you ensure is checked during Python installation on Windows? B) Install to a custom directory
...
What command is used to install pip on macOS and Linux? B) pip install python
...
What is the purpose of setting a root password during MySQL installation? C) To activate MySQL Workbench
